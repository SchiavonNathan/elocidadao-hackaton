...
import { School, Stethoscope, MapPin, Banknote, ThumbsUp, ThumbsDown, Lock } from "lucide-react"
...
export default function MarkerPopup({ title, type, address, spending, category }: MarkerPopupProps) {
  const Icon = category === "saude" ? Stethoscope : School
  ...
  return (
    <div className="w-[300px] p-2">
      <div className="flex items-center gap-2 mb-2">
        <Icon className={`h-5 w-5 ${category === "saude" ? "text-red-500" : "text-blue-500"}`} />
