...
export default function FeedbackDashboard() {
  ...
  const approvalByCategory = [
    ...
    {
      name: "Segurança",
      aprovados: feedbacks.filter((item) => item.categoria === "seguranca" && item.aprovacao === "sim").length,
      reprovados: feedbacks.filter((item) => item.categoria === "seguranca" && item.aprovacao === "nao").length,
    },
    {
      name: "Administração",
      aprovados: feedbacks.filter((item) => item.categoria === "administracao" && item.aprovacao === "sim").length,
      reprovados: feedbacks.filter((item) => item.categoria === "administracao" && item.aprovacao === "nao").length,
    },
  ]
  ...
  const securityFeedbacks = feedbacks.filter((item) => item.categoria === "seguranca").length
  const administrationFeedbacks = feedbacks.filter((item) => item.categoria === "administracao").length
      ...
      <div className="container mx-auto py-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{securityFeedbacks}</div>
              <p className="text-xs text-muted-foreground">Opiniões sobre gastos em segurança</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{administrationFeedbacks}</div>
              <p className="text-xs text-muted-foreground">Opiniões sobre gastos em administração</p>
            </CardContent>
          </Card>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                e avaliação dos gastos em saúde, educação, segurança e administração pública. Nossa meta é alcançar 5%
                de participação até o final do ano.
              </p>
            </div>
          </CardContent>
        </Card>
                      ...
                      {filteredData.length === 0 ? (
                        ...
                        filteredData.map((item, index) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <Badge variant={getCategoryColor(item.categoria) as any}>
