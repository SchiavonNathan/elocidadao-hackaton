...
export const defaultBadges: Badge[] = [
  ...
  },
  {
    ...
    description: "Enviou 10 opiniões sobre gastos em segurança",
    icon: "Shield",
    criteria: "Envie 10 opiniões sobre gastos em segurança",
    level: "prata",
  },
  {
    id: "administration_specialist",
    name: "Especialista em Administração",
    description: "Enviou 10 opiniões sobre gastos em administração pública",
    icon: "Building2",
    criteria: "Envie 10 opiniões sobre gastos em administração pública",
    level: "prata",
  },
...
export const defaultChallenges: Challenge[] = [
  ...
  },
  {
    ...
    description: "Envie 5 opiniões sobre gastos em segurança",
    icon: "Shield",
    points: 50,
    startDate: new Date(),
    endDate: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), // 14 dias
  ...
  {
    id: "administration_focus",
    title: "Foco na Administração",
    description: "Envie 5 opiniões sobre gastos em administração pública",
    icon: "Building2",
    points: 50,
    startDate: new Date(),
    endDate: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), // 14 dias
