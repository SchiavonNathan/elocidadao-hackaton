...
export interface Feedback {
  ...
  data: Date
  local: string
  categoria: "saude" | "educacao" | "seguranca" | "administracao"
  aprovacao: "sim" | "nao"
...
const dadosIniciais: Feedback[] = [
  ...
  // Adicionar alguns feedbacks para as novas categorias
  {
    id: "16",
  ...
  },
  {
    ...
    local: "Delegacia de Polícia Civil - Centro",
    categoria: "seguranca",
    aprovacao: "nao",
    justificativa: "Os gastos com viaturas são altos, mas muitas estão paradas por falta de manutenção.",
  },
  {
    id: "18",
    data: new Date(2025, 4, 27),
    local: "Prefeitura Municipal de Maringá",
  ...
  },
  {
    ...
    categoria: "administracao",
    aprovacao: "nao",
    justificativa: "Os gastos com pessoal são muito altos em comparação com outras secretarias.",
  },
  {
    id: "20",
    data: new Date(2025, 4, 29),
    local: "Secretaria de Obras Públicas",
    categoria: "administracao",
    aprovacao: "sim",
    justificativa: "",
  },
